    ...
    return (
        <div className="hotel">
            ...
            <HotelData
                ...
                imgs = {Trip1}
                heading = "Trip in Germany"
                text = "No holiday in Germany is complete without a visit to the capital, Berlin. The iconic city offers a wide "
                price = "Price: $1000"
                contact = "Contact: 1234567890 "
                loc = "https://www.google.com/maps"
                />
                ...
                text = "Tiny, multilingual Switzerland packs a lot into its landlocked borders: glitt"
                />
